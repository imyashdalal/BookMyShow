    ...
    <div className="hero min-h-screen bg-neutral">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="text-center lg:text-left lg:ml-8">
          ...
          <p className="py-6">
            Sign in to CineBook and continue your cinematic journey. Book tickets, write reviews, and explore the latest movies.
          </p>
        </div>
        <div className="card w-full max-w-sm shadow-2xl bg-neutral">
